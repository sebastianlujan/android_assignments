...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent ExplicitlyIntent = new Intent(this, ExplicitlyLoadedActivity.class );

		//  Start an Activity using that intent and the request code defined above		
		startActivityForResult(ExplicitlyIntent,GET_TEXT_REQUEST_CODE);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(( resultCode == RESULT_OK) && (requestCode == GET_TEXT_REQUEST_CODE)){
			...
			final String mUserString = data.getStringExtra("inputText");
			mUserTextView.setText(mUserString);
		}
